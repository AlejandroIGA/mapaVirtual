...
export const requestLocationPermission = async () => {
    ...
    return new Promise((resolve, reject) => {
        // Solicitar ubicación para triggear el prompt de permisos
...
export const startLocationTracking = async (onUpdate, onError, options) => {
    ...
    try {
        ...
        // Si los permisos están en 'prompt', solicitar primero
        ...
        // Si no podemos verificar permisos, intentar directamente
